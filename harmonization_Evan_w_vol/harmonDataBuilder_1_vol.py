  ...
  with open(os.path.join(path, filename), 'r') as f:
    ...
    for i in range(len(extractedDataDir_['Volume'])):
      if extractedDataDir_['Volume'][i] == "":
        print("Debin found empty volume!!!!! %d" % i)
        volumeList_.append(0)
      else:
    ...
    return genderList_, scannerList_, volumeList_, headline_, extractedDataDir_
...
def main():
  ...
  genderList0, scannerList0, volumeList0, headline, extractedDataDir = \
