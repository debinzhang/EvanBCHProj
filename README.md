...
##  8. harmonization_Evan_w_vol_age_scannertype
...
The harmonization script, ***harmonDataBuilder_1_vol_no_empty_vol_w_age_sannertype.py***, is modified from harmonization_Evan_w_vol/harmonDataBuilder_1_vol_no_empty_vol_w_age.py, to add scanner type covars as a new harmonization parameter.
