...
#draw_gender_and_hemi_shade_plots(lh_thicknessstd_region_list, rh_thicknessstd_region_list)
draw_gender_and_hemi_shade_plots(lh_thickness_region_list, rh_thickness_region_list)
