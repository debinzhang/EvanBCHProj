...
def main():
  ...
  print("len of scannerList0: %d" % len(scannerList0))
  print(scannerList0)

  print("len of genderList0: %d" % len(genderList0))
  print(genderList0)

  print("len of datasetList0: %d" % len(datasetList0))
  print(datasetList0)
  ...
  with open(args.output, "w") as f:
    ...
    for i in range(len(genderList0)):
      ...
      f.write("%d,%s,%s,%s,%s\n" % ((i+1),\
        extractedDataDir['Dataset'][i], extractedDataDir['Age'][i], extractedDataDir['eTIV'][i],','.join(map(str, postDatalist))))
