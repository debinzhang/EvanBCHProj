...
wd <- "/Users/dzhang/Gits/EvanBCHProj/z_score/05_09_2022_ouyang_new_way/12_12_optimize_harmo/"
setwd(wd)
source_python("draw_shaded_plot.py")
source_python("harmonDataBuilder_9_abcd_R_age_key.py")

# data_raw <- read.csv("all_subjects_cortical_metrics_LH_curvind_09_15_2022_preHarmo_clean.csv", stringsAsFactors = TRUE)
# data_harmo <- read.csv("all_subjects_cortical_metrics_LH_curvind_09_15_2022_postHarmo_clean.csv", stringsAsFactors = TRUE)
...
# data_raw <- read.csv("all_subjects_cortical_metrics_LH_meancurv_09_15_2022_preHarmo_clean.csv", stringsAsFactors = TRUE)
# data_harmo <- read.csv("all_subjects_cortical_metrics_LH_meancurv_09_15_2022_preHarmo_postharmo.csv", stringsAsFactors = TRUE)
...
data_analyse <- function(data_raw, data_harmo, feature, gen_csv=TRUE, gen_TukeyHSD=FALSE, 
  ...
  # !!!!!! change dataset to FALSE !!!!!!!
  rslt <- harmonize(src_no_file, outfile, scanertype=FALSE, Eb=FALSE, Mean_only=TRUE, dataset=TRUE, Age=TRUE, gen_plot=TRUE)
  #rslt <- harmonize(src_no_file, outfile, scanertype=FALSE, Eb=FALSE, Mean_only=TRUE, dataset=FALSE, Age=TRUE, gen_plot=TRUE)
   if (!rslt) {
...
process_all <- function(draw_hemi_plot=TRUE) {
  # process_lh_curvind()
