...
def extractDataSet(filename):
  ...
  with open(filename, 'r') as f:
    ...
    # generate Scanner Strength list:
    # for Melissa's data there are only two magnetic strength value: 2 or 3
    for i in range(len(extractedDataDir_['Magnetic_field_of_strength'])):
      if extractedDataDir_['Magnetic_field_of_strength'][i] == '2':
        scannerList_.append(1)
      elif extractedDataDir_['Magnetic_field_of_strength'][i] == '3':
...
def harmonize(srcfile, output, scanertype=False, dataset=False, Eb=False, Mean_only=False, Parametric=True, Age=False, gen_plot=False):
  ...
  for colname, datalist in extractedDataDir.items():
    if colname == "Dataset" or colname == "subjectId" or colname == "Age" or colname == "path" \
      ...
      or colname == "Type" or colname == "old_Age":
      # or colname == "Type" or colname == "zscore" or colname == "old_Age":
      continue
  ...
  # if scanertype:
  #   print("Covars adding scanertype")
  #   covars['scanertype'] = scannerTypeList0
  # if dataset:
  #   print("Covars adding dataset")
  #   covars['Dataset'] = datasetList0
  # if Age:
  #   print("Covars adding age")
  #   covars['Age'] = ageList0
  ...
  # if scanertype:
  #   print("categorical_cols adding scanertype")
  #   categorical_cols.append('scanertype')
  # if dataset:
  #   print("categorical_cols adding dataset")
  #   categorical_cols.append('Dataset')
  # if Age:
  #   print("categorical_cols adding Age")
  ...
  #Harmonization step:
  # mean_only: default False, 
  # eb: set to False so the harmonization model will be fit for each feature separately.
  # parametric: default true
  try:
...
# srcfile = "all_subjects_cortical_metrics_LH_curvind_09_15_2022_preHarmo_w_unknown_removed.csv"
# output  = "all_subjects_cortical_metrics_LH_curvind_09_15_2022_preHarmo_w_unknown_removed_harmo.csv"
# harmonize(srcfile, output, scanertype=False, dataset=False, Eb=False, Mean_only=False, Parametric=True, Age=False, gen_plot=False)

# srcfile = "/Users/dzhang/Gits/EvanBCHProj/z_score/05_09_2022_ouyang_new_way/02_03_23_volumn_trendline/eTIV_raw_no_all.csv"
# output = "/Users/dzhang/Gits/EvanBCHProj/z_score/05_09_2022_ouyang_new_way/02_03_23_volumn_trendline/eTIV_harmo_no_all.csv"
# harmonize(srcfile, output, scanertype=False, dataset=False, Eb=False, Mean_only=False, Parametric=True, Age=False, gen_plot=False)

#srcfile = "all_subjects_cortical_metrics_LH_curvind_09_15_2022_preHarmo_clean.csv"
#output = "all_subjects_cortical_metrics_LH_curvind_09_15_2022_postHarmo_clean.csv"
#harmonize(srcfile, output, scanertype=False, dataset=False, Eb=False, Mean_only=False, Parametric=True, Age=False, gen_plot=False)

# outfile = "raw_raw_new_underscore_clean.csv"
# harmo_file = "raw_raw_new_underscore_postharmo_clean.csv"
