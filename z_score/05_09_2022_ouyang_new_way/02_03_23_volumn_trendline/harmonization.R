...
process_lh_curvind <- function() {
  lh_curvind_region_list <- list("BrainSegVolNotVent", "eTIV",
                                 ...
                                 "lh_insula_curvind")
  lh_curvind_region_list0 <- list("BrainSegVolNotVent", "eTIV", "lh_bankssts_curvind", "lh_caudalanteriorcingulate_curvind")
...
# lh_curvind_region_list <- list("BrainSegVolNotVent", "eTIV", "lh_bankssts_curvind", "lh_caudalanteriorcingulate_curvind")
# gen_plot_all_region(lh_curvind_region_list, 3)
