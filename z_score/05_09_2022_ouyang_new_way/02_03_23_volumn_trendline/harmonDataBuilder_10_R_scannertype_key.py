...
def harmonize(srcfile, output, scanertype=False, dataset=False, Eb=False, Mean_only=False, Parametric=True, Age=False, gen_plot=False):
  ...
  try:
    ...
    print(e)
    print("batch len: %d.... gender len: %d... scannerType:%d" % (len(covars["batch"]), len(covars["gender"]), len(covars["scannerType"])))
    print("------------------")
    return False
...
# outfile = "lh_transversetemporal_thickness_raw_no_all.csv"
# harmo_file = "lh_transversetemporal_thickness_harmo_no_all.csv"
